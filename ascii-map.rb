class AsciiMap < Formula
  ...
  resource "certifi" do
    url "https://files.pythonhosted.org/packages/b8/97/074c7e6c43314cf87834cf81c8b3684a0d8e200155a5dc67e58a7d3838ae/certifi-2025.1.31.tar.gz"
    sha256 "3ebdeeb36d274070a9b0c2a71d798d1a1158674514ba2a58d3480072d627376a"
  end

  resource "charset-normalizer" do
    url "https://files.pythonhosted.org/packages/f5/63/065b2d8dd3876cd64fa9a04a32b620b78df025cd06282dd24bf05b64c1bd/charset_normalizer-3.4.1.tar.gz"
    sha256 "4192663eb4c75ca7732a3fc2667d8f583af41a2791653fea556a31c19b085731"
  end

  resource "idna" do
    url "https://files.pythonhosted.org/packages/ba/ce/bce2560e9d6d741169f481ac94d4d688cf621422b9bba09614cda68fe9ce/idna-3.10.tar.gz"
    sha256 "12f65c9b470ab0b375b6fa11e5a740361675a894793d56f5c8e44208ed6b23d9"
  end

  resource "requests" do
    url "https://files.pythonhosted.org/packages/63/70/25398bc6dc4f42dc000a6f9f061d152a537f8f90264022467145749712a2/requests-2.32.3.tar.gz"
    sha256 "553654177d4eb1e28518cf036ec37e02e1b4b57ccafc206e9ec19b31d368e0d4"
  end

  resource "urllib3" do
    url "https://files.pythonhosted.org/packages/e0/a9/3ca06c994f27303f90558dd8bc3bc398fa9050d4ad1e53e8784fcabe2665/urllib3-2.3.0.tar.gz"
    sha256 "1d0db2d0f04df344f664a4bf855e9b986b2451f28681432f819074fd441d8df5"
  end

  resource "numpy" do
    url "https://files.pythonhosted.org/packages/a7/66/c6c39bce86638f220f1882d2c88fbf5f280a568b200b3e7ddbc3741870ca/numpy-2.2.3.tar.gz"
