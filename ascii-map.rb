class AsciiMap < Formula
  ...
  # Dependencies that are heavy to compile are now fetched as binary wheels
  # or used from system (numpy)
  depends_on "numpy"

  # Binary wheels for macOS ARM64 / Universal2
  # This avoids compiling C extensions from source
  ...
  resource "mapbox-vector-tile" do
    url "https://files.pythonhosted.org/packages/50/79/cb2a50533c9c3b545eace2deffba0d002b56713c68b26b6ac1e53a4c1d18/mapbox_vector_tile-2.2.0-py3-none-any.whl"
  ...
  resource "pyclipper" do
    url "https://files.pythonhosted.org/packages/de/e3/64cf7794319b088c288706087141e53ac259c7959728303276d18adc665d/pyclipper-1.4.0-cp311-cp311-macosx_10_9_universal2.whl"
    sha256 "adcb7ca33c5bdc33cd775e8b3eadad54873c802a6d909067a57348bcb96e7a2d"
  end

  resource "shapely" do
    url "https://files.pythonhosted.org/packages/4f/ce/28fab8c772ce5db23a0d86bf0adaee0c4c79d5ad1db766055fa3dab442e2/shapely-2.1.2-cp311-cp311-macosx_11_0_arm64.whl"
